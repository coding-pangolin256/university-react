...
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (1,2,'student',NULL,'What is dummy?','2017-10-07 03:54:08',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (2,5,'teacher',NULL,'Dummy is a binary tree used for sort and search.','2017-10-07 03:55:33',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (3,2,'teacher',NULL,'Hello, how can I downgrade MySQL server?','2017-10-07 11:24:15',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (4,29,'student',NULL,'You can uninstall present server and then download previous version of MySQL server and install.','2017-10-07 11:27:49',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (5,1,'student',NULL,'How can I install MacOS on my computer.','2017-10-09 10:42:59',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (6,10,'student',NULL,'sdaf','2017-10-09 22:13:36',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (7,10,'student',NULL,'asdf','2017-10-09 22:13:37',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (8,10,'student',NULL,'asdf','2017-10-09 22:13:37',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (9,10,'student',NULL,'asdf','2017-10-09 22:13:38',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (10,10,'student',NULL,'asdf','2017-10-09 22:13:38',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (11,10,'student',NULL,'asdf','2017-10-09 22:13:38',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (12,10,'student',NULL,'asdf','2017-10-09 22:13:39',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (14,2,'teacher',42,'AdminLTE.min.css','2017-10-10 20:52:27',1);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (15,2,'teacher',42,'asdfawefasdf','2017-10-12 00:08:10',0);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (16,2,'teacher',42,'1.png','2017-10-12 00:32:00',1);
insert  into `chat`(`id`,`user_id`,`pos`,`course_id`,`text`,`time`,`type`) values (17,2,'teacher',42,'install.exe','2017-10-12 00:37:20',1);
...
insert  into `cj10244`(`std_id`,`24_hw`,`24_score`,`1_hw`,`1_score`) values (8,'bidSentence.txt',4,NULL,NULL);
insert  into `cj10244`(`std_id`,`24_hw`,`24_score`,`1_hw`,`1_score`) values (15,'globdata.ini',3,NULL,NULL);
...
insert  into `cj142`(`std_id`,`21_hw`,`21_score`,`22_hw`,`22_score`) values (29,'eula.1041.txt',NULL,'eula.1028.txt',NULL);
insert  into `cj142`(`std_id`,`21_hw`,`21_score`,`22_hw`,`22_score`) values (30,'eula.3082.txt',NULL,NULL,NULL);
